...
<xsl:stylesheet version="1.1" 
			...
			<fo:page-sequence master-reference="pages">
				...
				<fo:flow flow-name="body">
					...
					<fo:block font-size="16pt">
						<xsl:apply-templates select="n:polishWords"/>
					</fo:block>
					<fo:block font-size="16pt">
						<xsl:apply-templates select="n:dictation"/>
					</fo:block>
				</fo:flow>
			</fo:page-sequence>
	...
	<xsl:template match="n:dictation">
		<fo:block font-size="16pt" text-align="justify">
